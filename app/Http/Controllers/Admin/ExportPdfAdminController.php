...
class ExportPdfAdminController extends Controller
{
    public function getExportPDF(Request $request)
    {
        ...
        $pdf = PDF::loadview('components.admin.tranasksi-costumer.rekap-pdf', compact('detailsTransaksi', 'total', 'purchase_price', 'profit'))->setPaper('a4', 'landscape');
